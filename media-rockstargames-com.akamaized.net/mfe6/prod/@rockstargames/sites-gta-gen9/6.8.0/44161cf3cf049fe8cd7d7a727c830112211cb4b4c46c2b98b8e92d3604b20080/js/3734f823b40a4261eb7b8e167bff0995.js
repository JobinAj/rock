! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            s = (new Error).stack;
        s && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[s] = "236b6fb5-1a84-45d8-a12c-7baebe87c305", e._sentryDebugIdIdentifier = "sentry-dbid-236b6fb5-1a84-45d8-a12c-7baebe87c305")
    } catch (e) {}
}();
        ...
        60285: (e, s, i) => {
            ...
            const l = (0, n.withIntl)((e => {
                ...
                const p = (0, t.useRef)(null),
                    ...
                    g = /^#/.test(i),
                    b = m ? .target ? ? (l ? "_blank" : "_self");
                let { ...y
                } = m, v = "";
                if ("aria-label" in y && y["aria-label"] && (v = "_blank" === b ? `${y["aria-label"]} ${f.formatMessage(r.aria_label_open_new_window)}` : y["aria-label"]), (0, t.useEffect)((() => {
                    ...
                    return (0, c.jsxs)("a", {
                        ...
                        "aria-label": v,
                        ref: p,
                        children: [s, "_blank" === b && !v && (0, c.jsx)("span", {
                            className: _,
                            children: f.formatMessage(r.aria_label_open_new_window)
                        })]
                    })
                }
                if (k) return (0, c.jsxs)(o.NavLink, {
                    title: a,
                    to: i,
                    onClick: d,
                    ...y,
                ...
                const h = Object.keys(y).filter((e => !["activeClassName", "key", "end"].includes(e))).reduce(((e, s) => ({ ...e,
                    [s]: m[s]
                })), {});
...
//# sourceMappingURL=3734f823b40a4261eb7b8e167bff0995.js.map