! function() {
    try {
        var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            e = (new Error).stack;
        e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "d5a93a7a-1c28-4546-a4b0-51463a955792", t._sentryDebugIdIdentifier = "sentry-dbid-d5a93a7a-1c28-4546-a4b0-51463a955792")
    } catch (t) {}
}();
    ...
    [1225, 6677], {
        90250: (t, e, n) => {
            ...
            const M = (l.useMedium((function(t) {
                ...
                o.useEffect((function() {
                    return O.push(c), t.setCallbacks({
                            onScrollCapture: h,
                            onWheelCapture: h,
            ...
            const c = t => ({
                    ...
                    async fn(e) {
                        ...
                        const C = x / 2 - E / 2,
                            ...
                            O = R / 2 - g[m] / 2 + C,
                            _ = (0, r.qE)(A, O, D),
                            M = !s.arrow && null != (0, r.Sg)(i) && O != _ && a.reference[m] / 2 - (O < A ? L : k) - g[m] / 2 < 0,
                            P = M ? O < A ? O - A : O - D : 0;
                        return {
                            [h]: p[h] + P,
                            data: {
                            ...
                            if (S = [...S, {
                                ...
                                if (!n) switch (m) {
                                    case "bestFit":
                                        {
                                            var A;
                                            const t = null == (A = S.map((t => [t.placement, t.overflows.filter((t => t > 0)).reduce(((t, e) => t + e), 0)])).sort(((t, e) => t[1] - e[1]))[0]) ? void 0 : A[0];t && (n = t);
                                            break
                                        }
        ...
        31202: (t, e, n) => {
            ...
            function D(t, e) {
                const n = w(t);
                return !(n === e || !s(n) || g(n)) && ("fixed" === v(n).position || D(n, e))
            }
            ...
            function M(t, e) {
                ...
                if (!u(t)) return n;
                let r = _(t, e);
                for (; r && p(r) && "static" === v(r).position;) r = _(r, e);
                ...
                getClippingRect: function(t) {
                    ...
                    const c = [..."clippingAncestors" === n ? function(t, e) {
                            ...
                            for (; s(c) && !g(c);) {
                                const e = v(c),
                                    n = h(c);
                                n || "fixed" !== e.position || (o = null), (a ? !n && !o : !n && "static" === e.position && o && ["absolute", "fixed"].includes(o.position) || d(c) && !n && D(t, c)) ? r = r.filter((t => t !== c)) : o = e, c = w(c)
                            }
                            return e.set(t, r), r
...
//# sourceMappingURL=4fc51280119e6ace164082ceebc8f93c.js.map